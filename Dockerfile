...
ARG PROJECTS_WITH_VOICE_CALLING
...
ENV WHATSAPP_MMLITE_CONFIG_ID=${WHATSAPP_MMLITE_CONFIG_ID}
...
ENV PROJECTS_WITH_VOICE_CALLING=${PROJECTS_WITH_VOICE_CALLING}
