...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapState(my_apps, ['configuredApps', 'errorConfiguredApps', 'errorConfiguredApps', 'installedApps', 'loadingInstalledApps', 'errorInstalledApps']),
      hasApps: function () {
...
<style lang="scss" scoped>
  @import './MyApps/styles.scss';
</style>import { auth_store } from '@/stores/modules/auth.store';import { my_apps } from '@/stores/modules/myApps.store';
