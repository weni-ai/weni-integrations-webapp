<template>
  <div class="my-apps">
    ...
    <div
      v-if="hasApps"
      class="my-apps__sections"
    >
      <div
        v-if="
          searchTerm &&
          !filteredConfiguredApps.length &&
          !filteredInstalledApps.length
        "
      >
        <EmptyApps
          :term="searchTerm"
          @clear="navigateToDiscovery"
        />
      </div>
      <div
        v-else
        class="my-apps__sections__grids"
      >
        <AppGrid
          section="configured"
          type="edit"
    ...
    <div
      v-else
      class="my-apps__empty"
    >
      <img
        class="my-apps__empty__image"
        src="@/assets/svgs/empty-apps.svg"
      />
      ...
      <div class="my-apps__empty__description__secondary">
        ...
        <div
          class="my-apps__empty__description__secondary__link"
