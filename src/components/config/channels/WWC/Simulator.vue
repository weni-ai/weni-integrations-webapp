<template>
  ...
  >
    <Transition name="fade">
      <div
        v-if="isOpen"
        class="wwc-simulator__content"
      >
        <div class="wwc-simulator__content__header">
          <div
            v-if="!avatar"
            class="wwc-simulator__content__header__icon-container"
          >
            <UnnnicIconSvg
          ...
          <div
            v-else
            class="wwc-simulator__content__header__custom-icon"
          />
          ...
          <div class="wwc-simulator__content__header__button">
            ...
            />
            <div
              class="wwc-simulator__content__header__button__close"
              @click="toggleChat"
            >
              <UnnnicIconSvg
                icon="close-1"
        ...
        <div class="wwc-simulator__content__body">
          ...
          >
            ...
            />
            <div
              :class="`wwc-simulator__content__body__message--${message.direction}__content`"
            >
              <div
    ...
    <div
      class="wwc-simulator__button"
      @click="toggleChat"
    >
      <div
        v-if="displayUnreadCount && !isOpen"
        class="wwc-simulator__button__unread"
      >
        {{ 2 }}
      </div>
      <div
        v-if="!avatar"
        class="wwc-simulator__button__content"
      >
        <UnnnicIconSvg
      ...
      <div
        v-else
        class="wwc-simulator__button__custom-icon"
      />
    </div>
  </div>
</template>
        ...
        &--incoming {
          ...
          &__content {
            ...
            &__text {
              ...
              border-radius: 0px $unnnic-border-radius-sm
                $unnnic-border-radius-sm;
              padding: $unnnic-spacing-inset-nano;
