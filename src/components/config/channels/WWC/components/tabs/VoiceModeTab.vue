  ...
  <div class="voice-mode-tab">
    ...
    <div class="voice-mode-tab__token">
      <UnnnicInput
        ...
        :placeholder="
          $t('weniWebChat.config.voice_mode.elevenLabsApiKey.placeholder')
        "
      ...
      <div class="voice-mode-tab__voice-list">
        ...
        >
          ...
          >
            <section
              ...
              :class="{
                'voice-mode-tab__voice-row-content--disabled':
                  !voiceModeEnabled,
              }"
            >
              ...
              <span class="voice-mode-tab__voice-category">
                ({{
                  $t(
                    `weniWebChat.config.voice_mode.voice_category.${voice.categoryKey}`,
                  )
                }})
              </span>
            </section>
        ...
        >
          ...
          <UnnnicInput
            ...
            :placeholder="
              $t('weniWebChat.config.voice_mode.other_voice_placeholder')
            "
...
const isKnownVoice =
  ...
  PREDEFINED_VOICE_IDS.includes(props.initialElevenLabsVoiceId);
