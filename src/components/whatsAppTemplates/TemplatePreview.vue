<template>
  <div
    v-if="!loadingFetchWhatsAppTemplate"
    class="template-preview"
  >
    <div
      v-if="showTitle"
      class="template-preview__header"
    >
      <UnnnicIconSvg
        class="template-preview__header__icon"
        icon="view-1-1"
        size="lg"
      />
      <span class="template-preview__header__title">{{
        $t('WhatsApp.templates.preview')
      }}</span>
    </div>
    ...
    <div class="template-preview__content">
      <div v-if="hasHeader">
        ...
        <div v-else-if="currentForm.header.header_type === 'MEDIA'">
          ...
          <div
            v-else
            class="template-preview__content__header__icon-wrapper"
          >
            <UnnnicIconSvg
              :icon="headerIcon"
              size="lg"
      ...
      <div
        v-if="hasBody"
        class="template-preview__content__body"
      >
      ...
      <div
        v-if="hasFooter"
        class="template-preview__content__footer"
      >
      ...
      <div
        v-if="hasButtons"
        class="template-preview__action-buttons"
      >
        <div
    ...
    <div
      v-if="hasButtons"
      class="template-preview__buttons"
    >
      <div
        v-if="currentForm.buttons[0].button_type === 'QUICK_REPLY'"
