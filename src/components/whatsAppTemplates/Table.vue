        ...
        <UnnnicTableRow :headers="tableHeaders">
          ...
          <template #created_on>
            <div
              ...
              class="break-text whatsapp-templates-table__item__month"
            >
          ...
          <template #category>
            <div
              :title="item.category"
              class="break-text whatsapp-templates-table__item__category"
            >
              {{ item.category }}
            </div>
          </template>
...
export default {
  ...
  computed: {
    ...
    tableItems() {
      ...
      return (
        templates.filter((template) => template.translations?.length > 0) || []
      );
    },
    totalCount() {
    ...
    currentPageCount() {
      ...
      return value > this.whatsAppTemplates?.count
        ? this.whatsAppTemplates?.count || 0
        : value;
    },
    startDateObject() {
