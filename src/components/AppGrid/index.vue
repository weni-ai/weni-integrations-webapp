  ...
  <div ref="appGrid">
    ...
    >
      ...
      >
        ...
        />
        <p class="app-grid__header__title">
          {{ $t(`apps.discovery.categories.${section}`) }}
        </p>
      </div>
      ...
      <div class="app-grid__content">
        <UnnnicCard
          ...
          :iconSrc="appIcon(app)"
          :typeAction="
            app.generic ? (type === 'add' ? 'edit' : typeAction) : typeAction
          "
          :clickable="
      ...
      <div
        v-if="apps && apps.length > gridSize"
        class="app-grid__pagination"
      >
        <span
