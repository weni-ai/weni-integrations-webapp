...
export default {
  ...
  async updateComment(appCode, commentId, data) {
    return await request.$http.put(
      `${resource}/${appCode}/comments/${commentId}/`,
      data,
    );
  },
  async deleteComment(appCode, commentUuid) {
    return await request.$http.delete(
      `${resource}/${appCode}/comments/${commentUuid}/`,
    );
  },
  ...
  async getApp(appCode, appUuid) {
    return await request.$http
      .get(`${resource}/${appCode}/apps/${appUuid}/`)
      .then((r) => r.data);
  },
  ...
  async updateAppConfig(appCode, appUuid, data) {
    return await request.$http.patch(
      `${resource}/${appCode}/apps/${appUuid}/configure/`,
      data,
    );
  },
